                                                ...
                                                <div class="widget-body no-padding">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span nagiostats="NUMSVCACTCHK1M" unit="" critical="0"></span>
                                                                (<span nagiostats="PCTNUMSVCACTCHK1M" unit="%"></span>)
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td><= 5 <?php echo __('minutes'); ?></td>
                                                            <td>
                                                                <span nagiostats="NUMSVCACTCHK5M" unit="" critical="0"></span>
                                                                (<span nagiostats="PCTNUMSVCACTCHK5M" unit="%"></span>)
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td><= 15 <?php echo __('minutes'); ?></td>
                                                            <td>
                                                                <span nagiostats="NUMSVCACTCHK15M" unit="" critical="0"></span>
                                                                (<span nagiostats="PCTNUMSVCACTCHK15M" unit="%"></span>)
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td><= 60 <?php echo __('minutes'); ?></td>
                                                            <td>
                                                                <span nagiostats="NUMSVCACTCHK60M" unit="" critical="0"></span>
                                                                (<span nagiostats="PCTNUMSVCACTCHK60M" unit="%"></span>)
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                ...
                                                <div class="widget-body no-padding">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tr>
                                                            <td><= 1 <?php echo __('minute'); ?></td>
                                                            <td>
                                                                <span nagiostats="NUMHSTACTCHK1M" unit="" critical="0"></span>
                                                                (<span nagiostats="PCTNUMHSTACTCHK1M" unit="%"></span>)
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td><= 5 <?php echo __('minutes'); ?></td>
                                                            <td>
                                                                <span nagiostats="NUMHSTACTCHK5M" unit="" critical="0"></span>
                                                                (<span nagiostats="PCTNUMHSTACTCHK5M" unit="%"></span>)
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td><= 15 <?php echo __('minutes'); ?></td>
                                                            <td>
                                                                <span nagiostats="NUMHSTACTCHK15M" unit="" critical="0"></span>
                                                                (<span nagiostats="PCTNUMHSTACTCHK15M" unit="%"></span>)
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td><= 60 <?php echo __('minutes'); ?></td>
                                                            <td>
                                                                <span nagiostats="NUMHSTACTCHK60M" unit="" critical="0"></span>
                                                                (<span nagiostats="PCTNUMHSTACTCHK60M" unit="%"></span>)
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td><?php echo __('Since start'); ?></td>
                                                            <td>
                                                                <span nagiostats="NUMHSTCHECKED" unit="" critical="0"></span>
                                                                (<span nagiostats="PCTNUMHSTCHECKED" unit="%"></span>)
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
